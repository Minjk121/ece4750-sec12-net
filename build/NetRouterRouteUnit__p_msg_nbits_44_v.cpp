//========================================================================
// VNetRouterRouteUnit__p_msg_nbits_44_v.cpp
//========================================================================
...
#include "obj_dir_NetRouterRouteUnit__p_msg_nbits_44/VNetRouterRouteUnit__p_msg_nbits_44.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_NetRouterRouteUnit__p_msg_nbits_44/VNetRouterRouteUnit__p_msg_nbits_44__Syms.h"
#include "svdpi.h"
#endif
...
VNetRouterRouteUnit__p_msg_nbits_44_t * create_model( const char *vcd_filename ) {

  VNetRouterRouteUnit__p_msg_nbits_44_t * m;
  VNetRouterRouteUnit__p_msg_nbits_44   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VNetRouterRouteUnit__p_msg_nbits_44_t *) malloc( sizeof(VNetRouterRouteUnit__p_msg_nbits_44_t) );
  model = new VNetRouterRouteUnit__p_msg_nbits_44();
  ...
  m->clk = &model->clk;
  m->reset = &model->reset;
  m->router_id = &model->router_id;
  m->istream_msg = &model->istream_msg;
  m->istream_rdy = &model->istream_rdy;
  m->istream_val = &model->istream_val;
  m->ostream0_msg = &model->ostream0_msg;
  m->ostream0_rdy = &model->ostream0_rdy;
  m->ostream0_val = &model->ostream0_val;
  m->ostream1_msg = &model->ostream1_msg;
  m->ostream1_rdy = &model->ostream1_rdy;
  m->ostream1_val = &model->ostream1_val;
  m->ostream2_msg = &model->ostream2_msg;
  m->ostream2_rdy = &model->ostream2_rdy;
  m->ostream2_val = &model->ostream2_val;
...
void destroy_model( VNetRouterRouteUnit__p_msg_nbits_44_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VNetRouterRouteUnit__p_msg_nbits_44 * model = (VNetRouterRouteUnit__p_msg_nbits_44 *) m->model;
...
void comb_eval( VNetRouterRouteUnit__p_msg_nbits_44_t * m ) {
...
void seq_eval( VNetRouterRouteUnit__p_msg_nbits_44_t * m ) {
...
#if VLINETRACE
void trace( VNetRouterRouteUnit__p_msg_nbits_44_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_NetRouterRouteUnit___05Fp_msg_nbits_44__v );
